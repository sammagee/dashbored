...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_478c4dc2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_login_vue__ = __webpack_require__(216);
var disposed = false
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "font-bold no-underline text-black text-xs hover:text-grey-darker focus:text-grey-darker active:text-grey-darkest transition-all",
              attrs: { to: { name: "auth.password.request" } }
            },
            [_vm._v("\n      Forgot your info?\n    ")]
          )
        ],
